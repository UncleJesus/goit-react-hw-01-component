...
import Statistics from './js/components/Statistics/StatisticsList';
import Friends from './js/components/Fiends/FriendList';
import Transactions from './js/components/Transactions/TransactionHistory';
